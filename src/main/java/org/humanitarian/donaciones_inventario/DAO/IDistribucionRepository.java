...
@Query("SELECT FUNCTION('to_char', d.fechaProgramada, 'YYYY') as anio, FUNCTION('to_char', d.fechaProgramada, 'TMMonth') as mes, d.estado, COUNT(d) " +
       "FROM Distribucion d GROUP BY anio, mes, d.estado ORDER BY anio DESC, mes, d.estado")
